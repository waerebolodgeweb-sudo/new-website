...
const collage = [
  { src: "/about/story-left.jpg", alt: "Rice fields of the Flores valley" },
  { src: "/about/story-mid.jpg", alt: "Traditional cone-shaped Mbaru Niang house" },
  { src: "/about/story-right.jpg", alt: "Mr. Martin, dedicated local guide" },
];
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1.6fr_1fr] lg:gap-14">
          ...
          <div className="flex items-start gap-3 sm:gap-5">
            <div className="relative mt-6 h-52 w-1/4 flex-shrink-0 overflow-hidden rounded-2xl shadow-sm sm:mt-10 sm:h-72 lg:h-80">
              <Image src={collage[0].src} alt={collage[0].alt} fill className="object-cover" />
            </div>
            <div className="relative mt-12 h-48 w-2/5 overflow-hidden rounded-2xl shadow-sm sm:mt-20 sm:h-64 lg:h-72">
              <Image src={collage[1].src} alt={collage[1].alt} fill className="object-cover" />
            </div>
            <div className="flex-1">
              <div className="relative h-52 w-full overflow-hidden rounded-2xl shadow-sm sm:h-72 lg:h-80">
                <Image src={collage[2].src} alt={collage[2].alt} fill priority className="object-cover" />
              </div>
